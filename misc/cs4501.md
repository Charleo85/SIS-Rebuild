CS4501 SIS-Rebuild: Course Related
========

This is the markdown file for all related materials of the course [CS 4501 (Internet Scale Application)](https://github.com/thomaspinckney3/cs4501/blob/master/README.md) at University of Virginia. A total of seven (7) projects are completed during the semester; all codes/images/instructions can be found in this file or this directory.
...
- Using [Apache JMeter's](http://jmeter.apache.org/) GUI Application, a test was set up where 50 homepage requests were sent to the load balancer within a span of 10 seconds. This was done with the localhost as well as with the Digital Ocean droplet. Digital Ocean was significantly slower with respect to Latency as well as Connect Time. Results of the test in images as well as CSV files are below:
	...
	- [Digital Ocean results CSV File](https://github.com/Charleo85/SIS-Rebuild/blob/master/misc/Performance%20testing/JmeterDOResults.txt)
	- [Local Host results CSV File](https://github.com/Charleo85/SIS-Rebuild/blob/master/misc/Performance%20testing/JmeterHostResults.txt)
	- [Digital Ocean results PNG](https://github.com/Charleo85/SIS-Rebuild/blob/master/misc/Performance%20testing/Digital%20Ocean%20Load%20Testing%20Results.png)
	- [Local Host results PNG](https://github.com/Charleo85/SIS-Rebuild/blob/master/misc/Performance%20testing/Host%20Load%20Testing%20Results.png)
...
- Unit testing (See `models/api/tests.py` for details):
...
- December 13th
    - Finished project 7 (map/reduce with Apache Spark)
